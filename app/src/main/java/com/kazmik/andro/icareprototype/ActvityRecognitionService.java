...
public class ActvityRecognitionService extends IntentService  {

    private String TAG = this.getClass().getSimpleName();
    public ActvityRecognitionService() {
    ...
    protected void onHandleIntent(Intent intent) {
        if(ActivityRecognitionResult.hasResult(intent)){
            ...
            Intent i = new Intent("com.kazmik.andro.icareprototype.ACTIVITY_RECOGNITION_DATA");
