...
public class ActivityRecognition extends Activity implements GooglePlayServicesClient.ConnectionCallbacks,GooglePlayServicesClient.OnConnectionFailedListener {
   ...
   // private ActivityRecognitionClient arclient;
    ...
    public void onConnected(Bundle arg0) {
        Intent intent = new Intent(this, ActvityRecognitionService.class);
